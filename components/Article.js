...
export default function Articles() {
  ...
  const [isFavClicked, setIsFavClicked] = useState(
    Array(news.length).fill(false)
  );
  // const{activeIndex} = useSelector(state=>state.initialState)

  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=38aced7e6f6f46a18780b861502e6892"
    )
